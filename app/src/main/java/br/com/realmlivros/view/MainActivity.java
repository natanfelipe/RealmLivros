...
import br.com.realmlivros.adapter.ListaLivrosAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        ListaLivrosAdapter adapter = new ListaLivrosAdapter(this,listaLivros);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(MainActivity.this,AddEditLivro.class);
                startActivity(i);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i = new Intent(MainActivity.this,ActivityFoto.class);
            startActivity(i);
            return true;
        }
